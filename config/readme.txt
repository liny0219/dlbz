...
| SP          | `SP,角色[1~4],技能对象角色[0~4],怪物x,怪物y`                  | 释放前排特殊技能，目标角色索引(0无目标)，坐标可选                                              | `SP,1,0,0,0`<br>`SP,1,1,0,0`                                 |
| XSP         | `XSP,角色[1~4],技能对象角色[0~4],怪物x,怪物y`                  | 释放后排特殊技能，参数同SP                                                                     | `XSP,2,1,0,0`                                                |
| EX          | `EX,角色[1~4],技能对象角色[0~4],怪物x,怪物y`                  | 释放EX技能，参数同SP                                                                           | `EX,1,0,0,0`                                                 |
| Pet         | `Pet,宠物[1~4],技能对象角色[0~4],怪物x,怪物y`                  | 释放宠物技能，目标角色索引(0无目标)，坐标可选                                                  | `Pet,1,0,0,0`                                                |
