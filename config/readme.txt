...
| XRole             | `XRole,角色[1~4],技能[0~4],BP[0~3],技能对象角色[0~4],怪物x,怪物y` | 切换后排并攻击，参数同Role       
| RoleEx            | `RoleEx,角色[1~4],技能[0~4],BP[0~3],技能对象角色[0~4],怪物x,怪物y`      | 潜力切换形态技能
| XRoleEx           | `XRoleEx,角色[1~4],技能[0~4],BP[0~3],技能对象角色[0~4],怪物x,怪物y`     | 后排潜力切换形态技能                                                              | `XRole,3,1,2,0,0,0`                                          |
| SP                | `SP,角色[1~4],BP[0~3],必杀对象角色[0~4],怪物x,怪物y`                  | 释放前排必杀技能，目标角色索引(0无目标)，坐标可选                                              | `SP,1,0,0,0`<br>`SP,1,1,0,0`                                 |
| XSP               | `XSP,角色[1~4],BP[0~3],必杀对象角色[0~4],怪物x,怪物y`                  | 释放后排必杀技能，参数同SP                                                                     | `XSP,2,1,0,0`                                                |
...
| XPet              | `XPet,角色[1~4],BP[0~3],技能对象角色[0~4],怪物x,怪物y`                  | 释放后排宠物技能，参数同PET
...
| Run               | 无参数                                                        | 逃跑
| PressInRound      |`timeout,秒数`                                                | 长按跳过到下个战斗回合
---
